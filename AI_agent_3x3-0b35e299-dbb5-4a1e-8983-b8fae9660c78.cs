...
public class AI_agent_3x3 : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        transform.localPosition = new Vector3(-2.125f, 0.3026757f, 2.022489f);
        ...
        if (!movementCooldown)
        {
            ...
            switch (moving)
            {
                ...
                case 1:
                    ...
                    if (angle == 0)
                    {
                        transform.localPosition += new Vector3(0f, 0f, 1.869489f);
                        AddReward(-0.2f);
                    }
                    else if (angle == 90)
                    {
                        transform.localPosition += new Vector3(1.783f, 0f, 0f);
                        AddReward(-0.2f);
                    }
                    else if (angle == 180)
                    {
